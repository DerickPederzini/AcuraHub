...
INSERT INTO tb_capitulo (titulo, url_imagem, body, url_video, modulo_id) VALUES ('Como funciona?', '', 'Qualquer colaborador Eurofarma pode cadastrar uma ideia em poucos cliques pelo portal online ou por QR code, preenchendo um formulário simplificado detalhando o problema identificado e a solução sugerida.\nNão é necessária a implementação imediata – basta apresentar o conceito e a proposta.',  '', 2);
INSERT INTO tb_capitulo (titulo, url_imagem, body, url_video, modulo_id) VALUES ('Triagem inicial', '', 'O time EurON Six Sigma faz uma triagem para garantir que a sugestão se enquadre nos critérios do programa (potencial produtivo, financeiro, sustentável, segurança, qualidade etc).',  '', 2);
INSERT INTO tb_capitulo (titulo, url_imagem, body, url_video, modulo_id) VALUES ('Quais ideias são bem-vindas', '', 'A resposta é muito simples! Qualquer ideia que desejar, pense de maneira inovadora, nossos funcionários ficarão muito felizes em poder avaliar suas ideias e lhe dar o que voê merece.',  '', 3);
INSERT INTO tb_capitulo (titulo, url_imagem, body, url_video, modulo_id) VALUES ('Suas premiações.', '', 'Mas oque seria isso?\n\n Se comprovado impacto relevante (financeiro, produtividade, sustentabilidade), o colaborador recebe premiação em eventos especiais, conduzidos pelo CEO Global e alta liderança, apresentando sua solução à diretoria e Grupo Executivo. Ideias que geram ganho financeiro superior a R$ 1 milhão podem render ao proponente até 5% do valor economizado, limitado a R$ 120 mil.',  '', 3);
...
INSERT INTO tb_capitulo (titulo, url_imagem ,body, url_video, modulo_id) VALUES ('Introdução pt1', '','d',  'DJMIOSAIJODSAO', 8);
INSERT INTO tb_capitulo (titulo, url_imagem ,body, url_video, modulo_id) VALUES ('Introdução pt1', '','d',  'DJMIOSAIJODSAO', 9);
INSERT INTO tb_capitulo (titulo, url_imagem ,body, url_video, modulo_id) VALUES ('Introdução pt1', '','d',  'DJMIOSAIJODSAO', 10);
INSERT INTO tb_capitulo (titulo, url_imagem ,body, url_video, modulo_id) VALUES ('Introdução pt1', '','d',  'DJMIOSAIJODSAO', 11);

INSERT INTO tb_capitulo (titulo, url_imagem ,body, url_video, modulo_id) VALUES ('Introdução pt1', '','2',  'JDIOASIJDSAIOL', 12);
INSERT INTO tb_capitulo (titulo, url_imagem ,body, url_video, modulo_id) VALUES ('Introdução pt1', '','2',  'JDIOASIJDSAIOL', 13);
